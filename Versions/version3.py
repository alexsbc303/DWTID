...
def main():
    ...
    if analysis_choice == 'Threat Dashboard':
        ...
        if GENSIM_AVAILABLE:
            show_topic_modeling(crawled_result_df, text_column='combined_text', title="Market Listing Topics")
        else:
            show_meaningful_keyword_analysis(crawled_result_df, "Keyword Analysis")
        ...
        if GENSIM_AVAILABLE:
            show_topic_modeling(preprocessed_forum_df, text_column='Post Content', title="Forum Discussion Topics")
        else:
            show_meaningful_keyword_analysis(preprocessed_forum_df, "Forum Discussion Analysis")
